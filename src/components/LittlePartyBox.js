...
const LittlePartyBox = () => {
    ...
    return ( <
        ...
        <
        div className = 'group flex items-center h-16 transition-all flex-col lg:flex-row gap-4 cursor-pointer mb-1'
        onClick = {
            () => setclicked(!clicked) } >
        { " " } {
            clicked ? null : ( <
                React.Fragment >
                <
                img className = 'h-20 group-hover:h-0 transition-all'
                src = { partyex }
                alt = 'party-thumbnail' /
                >
                <
