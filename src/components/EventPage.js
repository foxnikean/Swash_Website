...
const EventPage = () => {
  ...
  useEffect(() => {
    event.tickets.map((ticket, i) => setCounts([...counts, 1]));
  }, []);
  ...
  return (
    <div className='bg-backgroundColor min-h-screen h-full min-w-screen'>
      ...
      <div className='flex mx-auto container px-48 relative'>
        ...
        <div className='w-1/6 flex flex-col items-center right-56 top-64 p-4 fixed bg-slate-200 rounded-md'>
            ...
            {event.tickets.map((ticket, i) => (
              <div className='flex w-full justify-between px-5 items-center border-b-2 border-mor pb-2'>
                ...
                <div className='flex items-center gap-3'>
                  <button className='text-3xl font-bold text-mor'  onClick={() => {
